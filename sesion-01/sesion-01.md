...
```mermaid
flowchart LR
    n1@{ label: "INICIO<br><span style=\"padding-left:\">-punto de partida<br>- investigaciones<br>- estudios<br>-contextos</span>" } --> n2@{ label: "PLANIFICACIÓN<br><span style=\"padding-left:\">diseño del proyecto</span>" }
    n2 --> n3["EJECUCIÓN<br>- acciones<br>- ejecución<br>- presupuestaria"]
    n3 --> n4["MONITOREO<br>- seguimiento<br>- indicadores de desempeño<br>- correcciones<br>- ajustes"]
    n4 --> n5["CIERRE<br>- evaluación resultados<br>- reporte<br>- socialización"]
```
